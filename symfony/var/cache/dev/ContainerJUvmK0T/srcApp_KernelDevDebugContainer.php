...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder62600 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerf3217 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiescf561 = [
        
    ];

    public function getConnection()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getConnection', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getMetadataFactory', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getExpressionBuilder', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'beginTransaction', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getCache', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getCache();
    }

    public function transactional($func)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'transactional', array('func' => $func), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->transactional($func);
    }

    public function commit()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'commit', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->commit();
    }

    public function rollback()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'rollback', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getClassMetadata', array('className' => $className), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'createQuery', array('dql' => $dql), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'createNamedQuery', array('name' => $name), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'createQueryBuilder', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'flush', array('entity' => $entity), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'clear', array('entityName' => $entityName), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->clear($entityName);
    }

    public function close()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'close', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->close();
    }

    public function persist($entity)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'persist', array('entity' => $entity), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'remove', array('entity' => $entity), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'refresh', array('entity' => $entity), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'detach', array('entity' => $entity), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'merge', array('entity' => $entity), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getRepository', array('entityName' => $entityName), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'contains', array('entity' => $entity), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getEventManager', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getConfiguration', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'isOpen', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getUnitOfWork', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getProxyFactory', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'initializeObject', array('obj' => $obj), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'getFilters', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'isFiltersStateClean', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'hasFilters', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return $this->valueHolder62600->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerf3217 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder62600) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder62600 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder62600->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, '__get', ['name' => $name], $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        if (isset(self::$publicPropertiescf561[$name])) {
            return $this->valueHolder62600->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder62600;
    ...
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;
    ...
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, '__isset', array('name' => $name), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;
    ...
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, '__unset', array('name' => $name), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;
    ...
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, '__clone', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        $this->valueHolder62600 = clone $this->valueHolder62600;
    }

    public function __sleep()
    {
        $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, '__sleep', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;

        return array('valueHolder62600');
    }
    ...
    {
        $this->initializerf3217 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerf3217;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerf3217 && ($this->initializerf3217->__invoke($valueHolder62600, $this, 'initializeProxy', array(), $this->initializerf3217) || 1) && $this->valueHolder62600 = $valueHolder62600;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder62600;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder62600;
    }
