...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd68a5 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer54dcd = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties47a00 = [
        
    ];

    public function getConnection()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getConnection', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getMetadataFactory', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getExpressionBuilder', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'beginTransaction', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getCache', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getCache();
    }

    public function transactional($func)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'transactional', array('func' => $func), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->transactional($func);
    }

    public function commit()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'commit', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->commit();
    }

    public function rollback()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'rollback', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getClassMetadata', array('className' => $className), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'createQuery', array('dql' => $dql), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'createNamedQuery', array('name' => $name), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'createQueryBuilder', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'flush', array('entity' => $entity), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'clear', array('entityName' => $entityName), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->clear($entityName);
    }

    public function close()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'close', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->close();
    }

    public function persist($entity)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'persist', array('entity' => $entity), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'remove', array('entity' => $entity), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'refresh', array('entity' => $entity), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'detach', array('entity' => $entity), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'merge', array('entity' => $entity), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getRepository', array('entityName' => $entityName), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'contains', array('entity' => $entity), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getEventManager', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getConfiguration', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'isOpen', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getUnitOfWork', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getProxyFactory', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'initializeObject', array('obj' => $obj), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'getFilters', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'isFiltersStateClean', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'hasFilters', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return $this->valueHolderd68a5->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer54dcd = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd68a5) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd68a5 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd68a5->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, '__get', ['name' => $name], $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        if (isset(self::$publicProperties47a00[$name])) {
            return $this->valueHolderd68a5->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd68a5;
    ...
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;
    ...
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, '__isset', array('name' => $name), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;
    ...
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, '__unset', array('name' => $name), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;
    ...
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, '__clone', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        $this->valueHolderd68a5 = clone $this->valueHolderd68a5;
    }

    public function __sleep()
    {
        $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, '__sleep', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;

        return array('valueHolderd68a5');
    }
    ...
    {
        $this->initializer54dcd = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer54dcd;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer54dcd && ($this->initializer54dcd->__invoke($valueHolderd68a5, $this, 'initializeProxy', array(), $this->initializer54dcd) || 1) && $this->valueHolderd68a5 = $valueHolderd68a5;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd68a5;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd68a5;
    }
