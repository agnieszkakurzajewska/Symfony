...
/* welcome.html.twig */
class __TwigTemplate_e076a3e6c71dc59c710a81fcf90df5945178db49d4171bef934aa57fd390d217 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "
<h1>Homepage</h1>
<p>Welcome to our shop. Today is ";
        // line 6
        echo twig_escape_filter($this->env, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 6, $this->source); })()), "html", null, true);
        echo "</p>
";
...
<h1>Homepage</h1>
<p>Welcome to our shop. Today is {{ product }}</p>
{%  endblock %}", "welcome.html.twig", "/var/www/symfony/templates/welcome.html.twig");
    }
}
